...
<body>
	...
	${info}
	<div class="container" style="background: gray">container</div>
	<canvas> </canvas>
	<div class="container-fluid" style="background: rgb(20%, 30%, 70%)">
		container-fluid
		<div class="row">
			<div class="col-md-4"
				style="height: 300px; background: url(/resource/images/1.jpg) no-repeat"></div>
			<div class="col-md-2"
				style="height: 300px; background: url(/resource/images/2.jpg) no-repeat"></div>
